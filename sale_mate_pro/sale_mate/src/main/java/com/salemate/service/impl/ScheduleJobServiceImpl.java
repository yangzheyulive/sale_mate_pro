...
import com.salemate.mapper.ScheduleJobMapper;
import com.salemate.model.ScheduleJobEntity;
import com.salemate.service.ScheduleJobService;
...
//	}
	...
	public void saveJob(ScheduleJobEntity scheduleJob) {
		...
		scheduleJob.setStatus(WxConstantKeys.ScheduleStatus.NORMAL.getValue());
    ...
    public void pause(Long[] jobIds) {
    	...
    	updateBatch(jobIds, WxConstantKeys.ScheduleStatus.PAUSE.getValue());
    }
    ...
    public void resume(Long[] jobIds) {
    	...
    	updateBatch(jobIds, WxConstantKeys.ScheduleStatus.NORMAL.getValue());
    }
